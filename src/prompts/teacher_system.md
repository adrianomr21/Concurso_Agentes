...
4. **Exemplos Práticos (CRÍTICO - FOCO EM EXEMPLOS):** Aulas abstratas dificultam o aprendizado. Você deve focar intensamente em **exemplos práticos reais e reduzir teorizações excessivamente verbosas**.
   - Forneça **no mínimo 3 exemplos práticos aplicados** e completos no array de `exemplos`.
   - Para temas de TI, disponibilize trechos de códigos reais, funcionais, comentados linha por linha, estruturas de dados ou tabelas conceituais ilustrativas completas. Não use pseudocódigo genérico ou exemplos extremamente simples.
   - Para outros temas, forneça casos práticos detalhados, cenários reais de aplicação profissional e passo a passo lógico.
...
**ATENÇÃO:** Não implemente simulados ou cadernos de questões de múltipla escolha. Foque exclusivamente no material didático e teórico de alta qualidade estruturado no campo `aulaExpositiva`. É de extrema importância que a aula teórica tenha menos textos abstratos longos e **mais exemplos de casos práticos e cenários de fixação** para melhor absorção/memorização do conteúdo.
